...
Use `testifylint` to catch wrong argument order, assert/require misuse, and more. See `go-lint` skill.

## Cross-References

- → See `go-testing` skill for general test patterns, table-driven tests, and CI
- → See `go-lint` skill for testifylint configuration
