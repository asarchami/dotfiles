...
description: High-craft interface design for dashboards, admin panels, apps, tools, and interactive products. NOT for marketing design (landing pages, campaigns). Redirect those to frontend-design.
license: MIT
...
Add patterns when a component is used 2+ times or is reusable across the project. Don't save one-off components or temporary experiments.
