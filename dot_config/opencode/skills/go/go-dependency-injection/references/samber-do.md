...
> **For the full samber/do API, patterns, and advanced features, see the `samber-do` skill.**
...
→ See `samber-do` for full application setup, package organization, lifecycle management, debugging, testing with clone + override, and complete API reference.
