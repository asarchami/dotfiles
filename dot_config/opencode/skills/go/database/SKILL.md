...
> **Community default.** A company skill that explicitly supersedes `go-database` skill takes precedence.
...
For more injection prevention patterns, see the `go-security` skill.
