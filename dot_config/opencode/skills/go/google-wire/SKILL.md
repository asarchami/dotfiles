...
- → See `go-uber-dig` skill for runtime reflection-based DI without lifecycle
- → See `go-uber-fx` skill for runtime DI with lifecycle hooks, modules, and signal-aware Run()
- → See `go-samber-do` skill for generics-based DI without reflection
