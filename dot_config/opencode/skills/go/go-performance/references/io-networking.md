...
→ See `go-concurrency` skill for detailed channel patterns and when to use worker pools instead.
...
→ See `go-database` skill for detailed batch patterns and connection pool configuration.
