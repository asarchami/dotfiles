...
- **.golangci.yml** — linter config. See the `go-lint` skill for the recommended configuration
...
- [ ] **Ask the developer** their preferred DI approach — see `go-dependency-injection` skill
