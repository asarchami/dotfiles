...
→ See `go-troubleshooting` skill (pprof.md) for on-demand debugging.
...
→ See `go-troubleshooting` pprof.md for the full pprof CLI reference (profile types, capturing, analyzing, commands).
